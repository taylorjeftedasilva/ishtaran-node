## Ishtaran Node.js/TypeScript SDK -- first public release

This is the first public **Development Preview** release of the official Ishtaran Node.js/TypeScript
SDK. It is not GA, not stable, and not production-ready -- see
