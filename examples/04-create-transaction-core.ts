...
// workflowVersionId is optional -- null here means this Transaction's lifecycle is tracked by
// this application itself, not by a platform Workflow (see concepts/workflows on the docs site).
const created = await client.transactions.create(organizationId, applicationId, environmentId, null, assetNetworkId, '250', participants);
